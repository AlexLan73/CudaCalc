/**
 * @file fft32_batch32_v2.cu
 * @brief FFT32 batch - EXACT copy of working single FFT32 with X dimension added
 */
...
__global__ void fft32_batch32_v2_kernel(
...
extern "C" void launch_fft32_batch32_v2(
    ...
    fft32_batch32_v2_kernel<<<grid, block>>>(d_input, d_output, num_windows);
}
