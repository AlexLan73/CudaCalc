...
- **Статус:** Specification completed, план в разработке
- **FFT16** (окно 16 точек)
- **Две реализации:** Tensor Cores (wmma) vs 2D Shared Memory
- **Baseline метрики** на RTX 3060
- **Система тестирования** (профилирование, валидация, архивирование)
- **Срок:** 2 недели
...
### Сейчас (октябрь 2025):
1. ✅ Spec-Kit настроен
2. ✅ Спецификация 001-fft16-baseline-pipeline создана
3. 🔄 Plan.md для FFT16 (в процессе)
4. 🔄 Реализация FFT16 (следующий шаг)
...
├── Tester/                 # Профилирование + валидация
